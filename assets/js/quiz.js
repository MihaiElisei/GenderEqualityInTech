...
function showResults() {
    ...
    mentorBtn.classList.remove('hide');
    ...
    switch (answeredYesCounter) {
        case 0:
            responseElement.innerText = `All right! You seem not to be interested to work in IT at the moment. This just might not be the right time for you, but why not to give it a chance? Just talk to one of our mentors. Best of luck!`;
            break;
        case 1:
            responseElement.innerText = `Cool! You answered Yes to one question. You just might need some extra time to consider this again. Meanwhile, feel free to talk to one of our mentors and they will be able to help you with your career. Best of luck!`;
            break;
        case 2:
            responseElement.innerText = `Nice! You answered Yes to two questions. We suggest to do some research and find out what role would suit you. Just reach out to our mentor team and they will be able to help you to start your new career. Best of luck!`;
            break;
        case 3:
            responseElement.innerText = `Great! You answered Yes to three questions. You probably know somewhere at the back of your mind what roles would you fit in. We strongly recomend to start the journey in near future. Our mentors are here to help you with this journey. Best of luck!`;
            break;
        case 4:
            responseElement.innerText = `Excellent! You answered Yes to four questions. You are more likely to end up in an IT role. Find out more about IT companies and roles to have good idea what it takes to be sucessfull. Our mentor team is here to support you. Just reach out. Best of luck!`;
            break;
        default:
            responseElement.innerText = `Astonishing! You answered Yes to all five questions. You are almost there! Don't worry if you dont have any IT experience. Talk to our mentors who will provide you with all information and help you to start your career. Best of luck! `;
    }
}
